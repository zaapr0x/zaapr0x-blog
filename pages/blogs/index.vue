  ...
  <main class="container max-w-5xl mx-auto text-zinc-600">
    ...
    <div class="px-6">
      <input
        ...
        placeholder="Search"
        type="text"
        class="block w-full bg-[#F1F2F4] dark:bg-[#181818] dark:placeholder-zinc-500 text-zinc-300 rounded-md border-gray-300 dark:border-[#2a2a2a] shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
      />
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-5 px-4">
    ...
    <div class="flex justify-center items-center space-x-6">
      <button :disabled="pageNumber <= 1" @click="onPreviousPageClick">
        <Icon
          ...
          size="30"
          :class="{ 'text-[#181818] dark:text-[#2a2a2a]': pageNumber > 1 }"
        />
      </button>
      ...
      <button :disabled="pageNumber >= totalPage" @click="onNextPageClick">
        <Icon
          ...
          size="30"
          :class="{ 'text-[#2a2a2a] dark:text-[#838383]': pageNumber < totalPage }"
        />
      </button>
    </div>
  </main>
